...
//    @JoinColumn(name = "field_id")
    ...
    public Student(Long id, String name, String surname, String username, String password) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.username = username;
    ...
    public Student(String name, String surname, List<Subject> subjects, List<PersonalityTrait> personalityTraits,
                   Field field, String username, String password) {
        this.name = name;
        this.surname = surname;
    ...
    public Student(Long id, String name, String surname, List<Subject> subjects,
                   ...
                   PersonalizedPlan personalizedPlan, String username, String password) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.subjects = subjects;
