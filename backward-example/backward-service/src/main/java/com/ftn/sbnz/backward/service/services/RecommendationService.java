...
public class RecommendationService {
    ...
    private Map<PersonalityTrait, List<LearningMethod>> getTraitRecommendations() {
    ...
    private Map<SubjectName, List<LearningMethod>> getSubjectRecommendations() {
    ...
    private Map<Field, List<LearningMethod>> getFieldRecommendations() {
